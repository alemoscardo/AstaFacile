        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#come-funziona" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Come Funziona
                </a>
              </li>
              <li>
                <a href="#perche-noi" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Perché Noi
                </a>
              </li>
              <li>
